...
class UserStoriesTest < ActionDispatch::IntegrationTest
  ...
  test "multiple users creating an article" do
    ...
    eugene.logs_in 'eugene@example.com', '123qwe'
    lauren.logs_in 'lauren@example.com', '123qwe'
    
    eugene.creates_article :title => 'Integration test', :body => 'Lorem Ipsun...'
    lauren.creates_article :title => 'Open session', :body => 'Lorem Ipsun...'
